...
public class Negative_Tests_signUp extends Tests_main {
	Boolean logged;
	
	@Test		
	public  void N_signUp_byEmail_exist() throws InterruptedException {
	...
	@Test		
	public  void N_signUp_byPhone_exist() throws InterruptedException {
